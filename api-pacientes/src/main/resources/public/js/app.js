(function() {
	...
	app.config(function($stateProvider, $urlRouterProvider, $controllerProvider){
		...
		$stateProvider
			...
			.state('pacientes',{
	        url:'/pacientes',
	        templateUrl: viewsPrefix + 'pacientes.html',
	        controller:'PacienteListController'
	    }).state('viewPaciente',{
	       url:'/pacientes/:id/view',
	       templateUrl: viewsPrefix + 'paciente-view.html',
	       controller:'PacienteViewController'
	    }).state('newPaciente',{
	        url:'/pacientes/new',
	        templateUrl: viewsPrefix + 'paciente-add.html',
	        controller:'PacienteCreateController'
	    }).state('editPaciente',{
	        url:'/pacientes/:id/edit',
	        templateUrl: viewsPrefix + 'paciente-edit.html',
